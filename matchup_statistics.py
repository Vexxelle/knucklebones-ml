...
players = [
    knucklebones.bots.Pupser,
    knucklebones.bots.Aggressive_Player,
    knucklebones.bots.Random_Player,
    knucklebones.bots.Sequential_Player,
    knucklebones.bots.Smart_Player,
    knucklebones.bots.Combo_Player,
    knucklebones.bots.Stupid_Player,
]
...
def gather_statistics(
    p1: knucklebones.bots.Player, p2: knucklebones.bots.Player, num_matches: int
) -> dict:
    match_outcomes = []
